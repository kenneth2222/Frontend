    ...
    {/* // <div className="space-y-28 py-12 mx-12 bg-custom-image text-white"> */}
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between py-16 px-8 lg:px-16 widthMargin relative">
        ...
        <div className="lg:w-1/2 mb-70 ml-20">
          <h1 className="text-8xl font-bold mb-6">Web 3 Global <br />Conference</h1>
          <p className="text-3xl font-light mb-8">Uniting leading experts from diverse industries on <br />a global scale</p>
          <p className="text-xl mb-8 flex items-center gap-4"><span className="flex items-center gap-1">
    What is W3GC?
    <Icon icon="tabler:brand-tabler" width="24" height="19"/></span><span className="flex items-center gap-1">What is the future of Web3?<Icon icon="tabler:brand-tabler" width="24" height="19"/></span><span className="flex items-center gap-1">Why should you care?<Icon icon="tabler:brand-tabler" width="24" height="19"/></span></p>
        </div>
...
<Icon icon="akar-icons:arrow-right" width="24" height="18" />
  ...
  <div className="bg-[#F5E9DE] text-black w-40 my-8 mx-8 rounded-2xl"><p className="py-4 text-center whitespace-nowrap">Up Comming Event</p></div>
  <div className="text-black my-8 mx-8 ">
    <p className="text-5xl font-bold mb-5">Web 3 Global Conference</p>
    <p className="text-2xl font-normal">Uniting leading experts from diverse industries on a global scale</p>
  </div>
  <div className="flex ">
  <div className="bg-black w-40 my-8 mx-8 rounded-2xl"><p className="py-4 text-center whitespace-nowrap">Book Ticket</p></div>
  <div className="bg-[#F5E9DE] text-black w-40 my-8 mx-8 rounded-2xl"><p className="py-4 text-center whitespace-nowrap">Learn More</p></div>
  </div>
  </div>
</section>
      ...
      <section className="py-16 px-8 lg:px-16 widthMargin">
        ...
        <p className="text-2xl mb-5">Lorem ipsum dolor sit amet consectetur. Dui tincidunt tortor maecenas laoreet consequat morbi pellentesque enim. 
          Scelerisque ultrices morbi porttitor leo proin dignissim est. Amet et sapien volutpat eu aliquam.</p>
        <div className="flex justify-between gap-8">
          {/* Speaker 1 */}
          <div className="bg-[#5A487A] rounded-xl p-3 w-140 flex items-center gap-8">
            <div className="w-50 h-50 rounded-3xl">
            <img src={conf1} alt="Logo" className="w-full h-full object-cover rounded-3xl" />
            </div>
            <div>
...
{/* Speaker 3 */}
      ...
      <section className="py-16 px-8 lg:px-16 widthMargin">
        ...
        <p className="text-2xl font-light">Lorem ipsum dolor sit amet consectetur. Dui tincidunt tortor maecenas laoreet consequat morbi <br />pellentesque enim. 
          Scelerisque ultrices morbi porttitor leo proin dignissim est. Amet et sapien volutpat eu aliquam.</p>
          <div className="text-2xl rounded-3xl border w-40 border-white flex items-center"><p className="my-0 px-2 font-normal">More Videos</p></div>
          </div>
        ...
        {/* Event Images Section One */}
          <div className="flex h-60  mt-9 gap-3">
            <div className="rounded-0"> 
              ...
              <p className="text-lg font-nomal bg-[#5A487A] my-0.5 pl-2 flex items-center justify-between pr-4">Title Of Video<Icon icon="line-md:hazard-lights-filled-loop" width="24" height="20" className="transform rotate-90"/></p>
              </div>
            <div className="rounded-0"> 
      ...
      <section className="py-16 px-8 lg:px-16 widthMargin">
        <div className="flex flex-col items-center">
          ...
          <p>Lorem ipsum dolor sit amet consectetur. Dui tincidunt tortor maecenas laoreet consequat morbi pellentesque enim. 
            Scelerisque ultrices morbi porttitor leo proin dignissim est. Amet et sapien volutpat eu aliquam. Accumsan varius consectetur at 
            suspendisse. Felis pharetra pulvinar aenean suspendisse velit orci. Elit imperdiet adipiscing lorem quam donec nulla integer faucibus. 
            Faucibus eleifend mauris malesuada lobortis venenatis. Arcu morbi nunc ac sed nascetur id sed ipsum. Sed ut at tortor at. 
            Massa dignissim ornare mattis congue neque vivamus sit facilisi at. Egestas faucibus est aliquam massa fringilla ultrices amet risus in. 
            Porttitor suscipit eget duis ut sed amet commodo magnis. Eget aliquet pharetra aliquam nullam sit mauris aliquet amet tempor. 
            Ut laoreet amet sed pharetra.  Massa dignissim ornare mattis congue neque vivamus sit facilisi at. Egestas faucibus est aliquam massa fringilla ultrices amet risus in. 
            Porttitor suscipit eget duis ut sed amet commodo magnis. Eget aliquet pharetra aliquam nullam sit mauris aliquet amet tempor. 
            Ut laoreet amet sed pharetra.</p>
          </div>
     ...
     <div className=" lg:px-16 h-70 mx-20 flex justify-between items-center">
      <div>
        ...
        <div className="flex gap-4 mt-2 mb-7">
          <Icon icon="akar-icons:facebook-fill" width="24" height="24" className="mr-4 bg-black" />
          <Icon icon="akar-icons:twitter-fill" width="24" height="24" className="mr-4 bg-black" />
          <Icon icon="akar-icons:linkedin-fill" width="24" height="24" className="mr-4 bg-black" />
          <Icon icon="akar-icons:instagram-fill" width="24" height="24" className="mr-4 bg-black" />
        </div>
        <p className="text-black text-xl">©2025 W3GC by Web Global Conference LLC. All rights reserved. <br />
        <span className="underline">Privacy Policy</span> & <span className="underline">Terms of Use</span></p>
      </div>


      <div className="h-40 w-120  mt-10 mb-10 footerEmail mx-0 px-0 flex flex-col justify-center items-center gap-2">
    <p className="ml-72">get the <span className="font-bold">latest news</span> as then coming </p>
    <div className="bg-[#F5E9DE] h-15 w-140 rounded-3xl flex justify-between items-center px-6">
      ...
      <div className="bg-black h-10 w-30 rounded-3xl flex justify-center items-center">Subscribe</div>
    </div>
      </div>
